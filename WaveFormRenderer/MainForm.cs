...
namespace WaveFormRendererApp
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            waveFormRenderer.OnReadHandler += (e, fms) => { format = e; frames = fms; };
            moreInformation.Click += (obj, e) => new WaveInformationForm(format).ShowDialog();
        ...
        {
            new FiltrForm(frames).ShowDialog();
        }

        private void button2_Click(object sender, EventArgs e)
        {
            new HadamarForm(frames).Show();
        }
    }
}
